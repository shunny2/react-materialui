...
import { ICitiesListing, CitiesService } from '../../shared/services/api/cities/CitiesService';
              ...
              return (
                <TableRow key={row.id}>
                  <TableCell sx={{ p: 1.2 }}>
                    ...
                    <IconButton title='edit' size='small' onClick={() => navigate(`/cities/details/${row.id}`)}>
